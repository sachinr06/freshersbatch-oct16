...
import SpringMongoRestProject.SpringMongo.service.ActionService;
...
public class UserController {
	...
	@RequestMapping(value="/actions", method=RequestMethod.GET,
			produces=MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody List<ActionCollection> getActions(@RequestHeader(value="auth-token")String sessionId){
		
		return actionService.getActions(sessionId);
	}
	
	@RequestMapping(value="/user", method=RequestMethod.GET,
			produces=MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody UserCollections getUser(@RequestHeader(value="auth-token")String sessionId){
	...
	@RequestMapping(value="/postAd", method=RequestMethod.POST,
			consumes=MediaType.APPLICATION_JSON_VALUE,
			produces=MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody AdvertisementCollection postAd(@RequestBody Advertisement ad,@RequestHeader(value="auth-token") String sessionId) {

	 return userService.postAd(ad, sessionId);
	}
}
